...
CREATE TABLE "workspace_settings" (
    ...
    CONSTRAINT "workspace_settings_pkey" PRIMARY KEY ("teamId")
);
...
-- AddForeignKey
ALTER TABLE "workspace_settings" ADD CONSTRAINT "workspace_settings_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "team"("id") ON DELETE CASCADE ON UPDATE CASCADE;
